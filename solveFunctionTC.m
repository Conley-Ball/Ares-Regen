function F = solveFunctionTC(T_w,w,b,t,t_r,d,d_r,h,l,T_aw,M,T,A,gamma,Cp_g,mu_g,Pr_g,Pc,C_star,C_star_eff,D_t,R,A_t,res,T_c,kT_chg,kT_rhg,kT_ci,kT_ri,kT_rb,S,h_c_l,h_c_nb,T_sat_c,P_sat_c,ratio,T_cb_g)
    ...
    T_cw = T_w(1) - res*h_chg*(T_aw-T_w(1));
    T_rw = T_w(2) - res*h_rhg*(T_aw-T_w(2));
    T_ci = T_cw - t_r/kT_chg/res*(T_w(1)-T_cw); % K
    T_ri = T_rw - t_r/kT_rhg/res*(T_w(2)-T_rw); % K
    ...
    Q_chg = b*h_chg*(T_aw-T_w(1)); % W/m
    Q_rhg = w*h_rhg*(T_aw-T_w(2)); % W/m
