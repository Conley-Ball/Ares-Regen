function F = solveFunctionTC(T_w,w,b,t,t_r,d,d_r,h,l,T_aw,M,T,A,gamma,Cp_g,mu_g,Pr_g,Pc,C_star,C_star_eff,D_t,R,A_t,res,T_c,kT_chg,kT_rhg,kT_ci,kT_ri,kT_rb,S,h_c_l,h_c_nb,T_sat_c,P_sat_c,ratio)
