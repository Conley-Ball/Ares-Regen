function [v_m_stress, Yield_iw, T_chg] = main_function(w_ch_min, w_rib, t_ins, h_ch, Pc,Pe,O_F, T_inlet,res,Thrust,C_star_eff,C_F_eff,L_star,t_out,ratio,AR, C_star, C_F, gamma, MW_g, Cp_g, mu_g, k_g, T_thr, Pr_g)
